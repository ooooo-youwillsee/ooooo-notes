...
4. 学习 Go 语言，通读 [Go 官网](https://golang.org/doc/)，+实践+代码+笔记。

   :zero::one:. [《A Tour of Go》](https://tour.golang.org/)  :white_check_mark:
   
   :zero::two:. [《Tutorial: Create a module》](https://golang.org/doc/tutorial/create-module)  :white_check_mark:
   
   :zero::three:. [《Writing Web Applications》](https://golang.org/doc/articles/wiki/)
...
5. 每周至少 5 道 [Leetcode](https://leetcode-cn.com/problemset/all/)。 :o:
